...
namespace Force_Directed_Maps
{
    public partial class CreateNewPage : Form
    {
        ...
        public CreateNewPage()
        {
            ...
            ToolTip1.SetToolTip(this.button1, "Create a new type of chart with any forces you want");
        }
        ...
        {
            List<IForceActor> forces = new List<IForceActor>();
            forces.Add(new ElectroRepulsion_FA());
            forces.Add(new Springs_FA());
            forces.Add(new CornerRep_FA());
            string t = "";
            foreach (IForceActor f in forces) t += "\n • " + f.ForceName();
            ToolTip1.SetToolTip(this.spider, "Forces acting:" + t);
            //Diagramm = new SpiderDiagram();
            diagram = new Diagram(forces);
            this.Close();
        }
        ...
        private void CreateNewPage_Load(object sender, EventArgs e)
        {
            ...
            int y = 0;
            AddButton(PresetPanel, "Spider meme",ref y, new List<IForceActor>(new IForceActor[] { new ElectroRepulsion_FA(), new Springs_FA(), new CornerRep_FA() }));
